import { Modal, Button, Paper, Zoom, Backdrop, styled } from "@mui/material"
import { useReducer } from "react"

const BlueBackdrop = styled(Backdrop)(({ theme }) => ({
    backgroundColor: "rgba(0,0,255,0.35)",
    zIndex: -1,
}))

export function ModalCustomization() {
